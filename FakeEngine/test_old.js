...
let cursor2 = new Circle(Vector2.Zero, 1, 0, 'red')
let pause = false;
SparkX.Settings.PixelsPerPoint = 100
let PositionToBe = new Vector2(0, 0)
let plot = 100;
let points = 1
...
SparkX.RenderLoop(()=>{
  ...
  SparkX.ConstSettings.Cam.Position = Vector2.Lerp(SparkX.ConstSettings.Cam.Position, PositionToBe, 0.5)
    ...
    cursor.Position = Vector2.Lerp(cursor.Position, Input.Mouse.Position, 0.5)
    cursor2.Position = Vector2.Lerp(cursor.Position, Input.Mouse.Position, 0.6)
